...
%---
\begin{abstract}
Die steigende Komplexität moderner Webanwendungen erfordert neue Ansätze zur Modularität, Wiederverwendbarkeit und Skalierbarkeit. Traditionelle Architekturen erschweren die Wiederverwendung und Modularisierung von Code, was zu erhöhter Komplexität und eingeschränkter Wartbarkeit führt. Diese Arbeit zielt darauf ab, komponentenbasierte Web Development Ansätze mit herkömmlichen Lösungen zu vergleichen, um deren Vor- und Nachteile offenzulegen.

Dazu werden die Frameworks Angular und React sowie die JavaScript-Bibliothek jQuery und der Standard Web Components anhand der Implementierung einer E-Commerce-Plattform verglichen. Der Vergleich berücksichtigt eine breite Auswahl an Metriken, darunter Performance, Wartbarkeit, Erweiterbarkeit, Skalierbarkeit, Entwicklungsaufwand, Modularität und Komplexität.

Die Ergebnisse zeigen deutlich, dass komponentenbasierte Ansätze erhebliche Vorteile für moderne Webanwendungen bieten. Insbesondere in Bezug auf Wiederverwendbarkeit, Wartbarkeit und Performance stellen sie eine zukunftsfähige und zeitgemäße Lösung dar.
...
\listofabbreviations
\begin{acronym}[AJAX]  % Längstes Kürzel in der nachfolgenden
...
\acro{TTFB}[TTFB]{Time to First Byte}
\acro{FCP}[FCP]{First Contentful Paint}
