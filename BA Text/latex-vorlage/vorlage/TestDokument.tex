...
\lstinputlisting {code/checkout.component.ts}
...
\lstinputlisting {code/checkout.component.html}
...
\lstinputlisting {code/checkout.js}

In React wird fetch() in Kombination mit useEffect() und Promiese.all für eine parallele Datenverarbeitung genutzt. Die Anzeige von Komponente erfolgt über den Tag \texttt{<CartComponent/>}. Für das State Management wird useState() verwendet.
Die Navigation wird über den React Router mit \texttt{useNavigate()} gesteuert. 

\lstinputlisting {code/jqcheckout.js}

Der Checkout-Prozess

\lstinputlisting {code/checkout-component.js}
